  ...
  return (
    <View className="flex-row items-end gap-2 px-4 py-3 border-t border-zinc-200 dark:border-zinc-800 bg-bg dark:bg-bg-dark">
      <TextInput
        ...
        multiline
        editable={!disabled}
        className="flex-1 px-4 py-2.5 rounded-xl bg-surface-alt dark:bg-surface-dark text-base text-zinc-900 dark:text-zinc-50"
      ...
      <Pressable
        ...
        className="items-center justify-center w-12 h-12 rounded-xl bg-primary disabled:opacity-40 active:scale-95 flex-shrink-0"
